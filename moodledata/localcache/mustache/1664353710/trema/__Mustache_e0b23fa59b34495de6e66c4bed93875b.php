...
class __Mustache_e0b23fa59b34495de6e66c4bed93875b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB0e2c7cf2e65000a898a485250d5da77($context, $indent, $value);
    ...
    private function sectionB0e2c7cf2e65000a898a485250d5da77(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
