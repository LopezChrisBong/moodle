...
class __Mustache_8d334c1a06f09e840de8e22ee6ae077f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockBd6c0c6699a1afa3d43ff93dd6bd25d0'),
            ));
...
';
    ...
    public function blockBd6c0c6699a1afa3d43ff93dd6bd25d0($context)
    {
        $indent = $buffer = '';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
