...
class __Mustache_54fca91d6a67c2668237508d22fbeff3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section302b283b7169427ab53ffa49f824a43b($context, $indent, $value);
        $value = $context->find('headerdisplaymultipage');
        if (empty($value)) {
            
            $value = $context->find('sitehome');
            $buffer .= $this->sectionA3b041260ca4bc4324163ea36197312f($context, $indent, $value);
            $value = $context->find('sitehome');
            if (empty($value)) {
...
';
    ...
    private function section302b283b7169427ab53ffa49f824a43b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA3b041260ca4bc4324163ea36197312f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
