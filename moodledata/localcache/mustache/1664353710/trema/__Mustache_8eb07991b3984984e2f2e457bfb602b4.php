...
class __Mustache_8eb07991b3984984e2f2e457bfb602b4 extends Mustache_Template
{
...
';
        $buffer .= $indent . '  
';
        $buffer .= $indent . '  background-image:url([[pix:theme|bg]]);
';
        $buffer .= $indent . '  background-size: cover;
';
        $buffer .= $indent . '  background-position: fixed;
';
        $buffer .= $indent . '  mask-repeat: no-repeat;
';
        $buffer .= $indent . '}
';
        $buffer .= $indent . '
