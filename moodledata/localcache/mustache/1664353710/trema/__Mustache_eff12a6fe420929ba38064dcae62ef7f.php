...
class __Mustache_eff12a6fe420929ba38064dcae62ef7f extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_overview_section')) {
            $context->pushBlockContext(array(
                ...
                'title' => array($this, 'block35a289de46495166dca46040bef99ea7'),
                'placeholder' => array($this, 'blockF2ca03fecb95f213685459140a6ae494'),
                'emptymessage' => array($this, 'blockFc385e0e3683af3de6dd21a84774fa72'),
            ));
    ...
    public function block35a289de46495166dca46040bef99ea7($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function blockFc385e0e3683af3de6dd21a84774fa72($context)
    {
        $indent = $buffer = '';
