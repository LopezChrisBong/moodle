...
class __Mustache_14e7d73eaa226f9d91aaa51e0a05dd88 extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
            $context->pushBlockContext(array(
                ...
                'drawerheading' => array($this, 'block298ec220c6639eeb72e8103ec5aa28fa'),
                'drawercontent' => array($this, 'block579e35f7d138abe6417253c204676f63'),
...
';
    ...
    public function block298ec220c6639eeb72e8103ec5aa28fa($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function block579e35f7d138abe6417253c204676f63($context)
    {
        $indent = $buffer = '';
