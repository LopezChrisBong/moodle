...
class __Mustache_bcc401b9563c6ee1bf60ebc98f8feaa5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('mod_forum/discussion_list')) {
            $context->pushBlockContext(array(
                ...
                'discussion_list_output' => array($this, 'block7cb77111f085383b4dc59a1f505b2a1f'),
            ));
       ...
       ';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('mod_forum/forum_discussion_post')) {
                    $context->pushBlockContext(array(
                        'footer' => array($this, 'block49972d425c73cb7ffa913a911bbbdbda'),
...
';
    ...
    public function block49972d425c73cb7ffa913a911bbbdbda($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function block7cb77111f085383b4dc59a1f505b2a1f($context)
    {
        $indent = $buffer = '';
